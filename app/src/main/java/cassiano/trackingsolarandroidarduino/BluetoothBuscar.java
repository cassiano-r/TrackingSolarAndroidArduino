...
public class BluetoothBuscar extends BluetoothCheckActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooth_buscar);
    ...
    protected void onResume() {
        ...
        if(btfAdapter != null) {
            ...
            dialog = ProgressDialog.show(this, "Trancking Solar", "Buscando dispositivos bluetooth...",
                    false, true);
        }
    }
